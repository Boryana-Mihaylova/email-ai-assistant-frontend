...
- Load sample emails using the Load Demo button to quickly explore the application
- Paste and analyze your own emails in a single input area
- Clean pasted emails by removing extra line breaks and spacing using the Clean Formatting helper to enable more effective analysis
